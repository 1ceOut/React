...
const DetailMainContent = ({ setIsModalVisible }) => {
  ...
  const sortedData = React.useMemo(() => {
    ...
    const sortByDiscount = (a, b) => {
      const totalA =
        parsePrice(a.review_count) +
        Number(a.discount_percent.replace("%", ""));
      const totalB =
        parsePrice(b.review_count) +
    ...
    if (discount) {
      filteredData = filteredData.filter(
        (item) => item.discount_percent !== null
      );
    }
  ...
  return (
    <div className="max-h-[830px]">
      <div className="self-stretch mt-[30px] mx-auto max-w-[342px]">
        ...
        <div className="mt-[10px] mb-8"></div>
          ...
          <div className="w-[342px]">
            {isModalVisible && (
              <div className="w-[342px]">
                ...
                <div className="fixed bg-white w-[342px] h-[408px] px-6 z-50 rounded-2xl">
                  ...
                  <div className="cursor-pointer mt-8 flex justify-evenly flex-col">
                    <div>
                      <div className="font-semibold text-[16px] mb-6">
                        가격순
                      </div>
                      <div className="font-medium text-[14px] text-[#767676] flex space-x-10 justify-center">
                        <RadioGroup
                          defaultValue=""
                    ...
                    <div>
                      <div className="font-semibold text-[16px] mt-[40px] mb-3">
                        기타
                      </div>

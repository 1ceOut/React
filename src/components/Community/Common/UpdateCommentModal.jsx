    ...
    <div className="fixed inset-0 flex items-center justify-center z-50">
      ...
      <div className="relative bg-white w-[90%] max-w-lg p-5 rounded-lg shadow-lg">
        <div className="flex justify-between text-lg">
          ...
          <div className="flex font-bold">요리후기(리뷰)</div>
          <div
        ...
        <div className="border-[2px] w-full min-h-28 h-auto mt-2 rounded-xl">
          <textarea
            id="food"
            name="food"
            type="text"
            placeholder="감사의 한마디 부탁드려요!"
            className="block outline-none pl-3 text-gray-900 placeholder:text-[#A8A8A8] rounded-xl"
            value={comment}

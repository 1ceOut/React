    ...
    <div className="self-stretch flex justify-between items-center mt-6 mb-8">
      <div className="self-stretch flex items-center justify-center">
        ...
        <div className="flex justify-evenly items-center w-52">
          ...
          <div
            className="flex flex-col justify-center items-center w-[114px]"
      ...
      {showFollowerModal && (
        <div className="fixed inset-0 z-10 flex items-center justify-center bg-black bg-opacity-50">
          <div
            className="bg-white p-4 rounded-lg shadow-lg w-64 max-h-[700px] overflow-scroll"
          ...
          >
            ...
            <button
              className="bg-blue-600 text-white px-4 py-2 rounded-full mx-auto block mt-2"

...
import RecipeSearchModal from "../../components/Refrigerator/FridgeManage/RecipeSearchModal.jsx";
...
const FridgeManagePage = () => {
    ...
    const [isRecipeSearchModalOpen, setIsRecipeSearchModalOpen] = useState(false); // 레시피 검색 모달 상태 추가
    ...
    return (
        <main className="flex flex-col items-center px-6 pt-5 pb-20 mx-auto w-full max-w-[390px]">
            ...
            {/* 하단 버튼 추가 */}
            <div className="fixed bottom-24 right-4 flex justify-end">
                <button
                    className="bg-blue-500 text-white px-4 py-2 rounded-full shadow-lg"
                    onClick={() => setIsRecipeSearchModalOpen(true)} // 레시피 검색 모달 열기
                >
                    레시피 검색
                </button>
            </div>

    ...
    return (
        <main className="flex flex-col items-center px-6 pt-5 pb-2 mx-auto w-full max-w-[390px] h-screen">
            ...
            <div style={{width:342,height:87,marginTop:32}}>
                ...
                <div style={{width:342,height:56,top:249,left:24,borderRadius:12,marginTop:12, border: '1px solid #E1E1E1'}}>
                    <p style={{width:24,height:19,marginTop:18,marginLeft:20,fontSize:16}}>3개</p>
                </div>
            </div>
                ...
                >
                    ...
                    >
                        <div style={{
                            ...
                            <div style={{width:245,height:19,fontSize:16,fontWeight:500,marginTop:15,marginLeft:40}}>
                        ...
                        <div style={{ display: "flex", justifyContent: "space-around" }}>
                            <button
                                onClick={togglePopup}
                                style={{
                                   width:146,height:56,top:515,left:44,borderRadius:12, border: '1px solid #E1E1E1',
                                   marginTop:25,
                                   marginLeft:15,
                                    cursor: "pointer"
                                }}

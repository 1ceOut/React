  ...
  return (
    <main className="flex flex-col items-center px-6 pt-5 pb-2 mx-auto w-full max-w-[390px] h-auto overflow-auto">
      ...
      <div className="relative w-[342px] h-[60px] mt-5 flex items-center rounded-xl">
        <div className="flex items-center">
          <div className="flex items-center justify-center w-[60px] h-[60px] rounded-xl bg-[#F0F0F0]">
            <img
              src={getCategoryImage(lcategory)}
              alt=""
              className="w-[40px] h-[40px]"
            />
          </div>
          <div>
            <div className="text-[#767676] text-[14px] font-normal ml-3">
              {productType}
            </div>
      ...
      <div className="w-[342px] h-[87px] mt-5">
        <p className="text-[16px] font-medium">소비기한</p>
        ...
        <div className="border-2 border-black w-[342px] font-sans text-[#333] p-2 mt-8">
          <div className="text-left">
            ...
            <p style={{ margin: "5px 0", fontSize: "0.9em", color: "#aaa" }}>
              ...
              {nutritionInfo.personal || basic}
              {nutritionInfo.personal_unit} x {count}개)
            </p>
          </div>
          ...
          <table className="w-full border-collapse mt-2">
            <thead>
              <tr>
                <th className="text-left text-[0.8em] text-[#777] pb-1 border-b border-[#ddd]">
                  영양소
                </th>
                <th className="text-right text-[0.8em] text-[#777] pb-1 border-b border-[#ddd]">
                  {nutritionInfo.personal || basic}(
                  {nutritionInfo.personal_unit || "g"})당 영양성분
                </th>
              </tr>
            </thead>
            <tbody>
